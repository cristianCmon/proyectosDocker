...
\end{figure}
\noindent \\\\Es un quebradero de cabeza muy elevado crear una plantilla decente sino se tienen en cuenta todas las dificultades existentes.
\newpage
...
% \noindent \\01
% \newpage
\noindent \\docker exec -u 0 -it d-odoo /bin/bash
exit
