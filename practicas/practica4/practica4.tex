...
\noindent \\En esta primera actividad modificaremos el ejemplo de la práctica anterior \textit{``módulo Lista de tareas''} para que:\\
\begin{itemize}
...
\noindent \\Las primeras capturas mostrarán el código creado/modificado e intentarán ser lo suficientemente
autoexplicativas para una correcta comprensión del mismo
\newpage

\section{Actividad 02 - Biblioteca de cómics}
\noindent \\En esta segunda actividad...
\newpage

\section{Actividad 03 - Hospital}
\noindent \\En esta tercera actividad...
\newpage

\section{Actividad 04 - Instituto}
\noindent \\En esta cuarta y última actividad...
\newpage
